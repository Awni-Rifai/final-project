<?php require_once "../includes/login_inc.php"  ?>
<?php
//ERROR Handling
if(isset($_GET['email'])) {
                        ...
                        <div class="login-form">
                            <form action="../includes/login_inc.php" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="text-danger"><?php echo (isset($error_email))?$error_email:""; ?></div>
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" name="password" placeholder="Password">
                                    <div class="text-danger"><?php echo (isset($error_password))?$error_password:""; ?></div>
                                </div>
